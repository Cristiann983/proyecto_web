...
<head>
    ...
    <title>DevTeams - Crear Usuario</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span class="text-gray-900 font-medium">Crear Nuevo Usuario</span>
        </div>

        <!-- Título de sección -->
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Crear Nuevo Usuario</h2>
            <p class="text-gray-600">Completa el formulario para crear un nuevo usuario en el sistema</p>
        </div>
        ...
        <!-- Formulario -->
        <form method="POST" action="{{ route('admin.usuarios.store') }}" class="bg-white rounded-xl shadow-lg p-8" id="userForm">
            @csrf
